    ...
    if x > 1:
        while power_of_two != x:
            ...
            if next_power_of_two > x:
                if abs(x - power_of_two) == abs(x - next_power_of_two):
                    return max(power_of_two, next_power_of_two)
                elif min((x - power_of_two),(next_power_of_two - x)) == (x - power_of_two):
                    return power_of_two
                else:
        ...
        while power_of_two != x:
            ...
            if next_power_of_two < x:
                if abs(x - power_of_two) == abs(x - next_power_of_two):
                    return max(power_of_two, next_power_of_two)
                elif min((x - power_of_two), (x - next_power_of_two)) == (x - next_power_of_two):
                    return next_power_of_two
                else:
                    return power_of_two
            power_of_two = power_of_two / 2
