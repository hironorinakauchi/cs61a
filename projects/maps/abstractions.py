...
def restaurant_ratings(restaurant):
    ...
    # BEGIN Question 1
    # return [review_rating(n) for n in restaurant['reviews'] if review_restaurant_name(n) == restaurant_name(restaurant)]
...
def restaurant_mean_rating(restaurant):
    ...
    # BEGIN Question 2
    return sum(restaurant_ratings(restaurant))/float(len(restaurant_ratings(restaurant)))
    # END Question 2
