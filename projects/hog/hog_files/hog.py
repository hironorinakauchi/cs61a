...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN Question 7
    counter, best_number_rolls, best_avg = 10, 0, 0
    while counter > 0:
        average = make_averaged(roll_dice)(counter, dice)
        if average >= best_avg:
            best_avg = average
            best_number_rolls = counter
        counter -= 1
    return best_number_rolls
...
def final_strategy(score, opponent_score):
    ...
    #         beneficial_swap = is_swap(score, opponent_score)
    #         if beneficial_swap:
    #             return number_rolls
    #             number_rolls -= 1
    #         else:
    ...
    if (score + opponent_score) % 7 == 0:
        number_rolls = 1
    # elif score > 90 and opponent_score > 90:
    #      return bacon_strategy(score, opponent_score, 0)
    y = bacon_strategy(score, opponent_score, 6, number_rolls)
    return swap_strategy(score, opponent_score, y)
